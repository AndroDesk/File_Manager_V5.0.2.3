.class public Lcom/micloud/midrive/session/DownloadSession;
...
.method public constructor <init>(Lcom/micloud/midrive/session/params/SessionParams;Lcom/micloud/midrive/session/BaseSession$SessionListener;)V
    ...
    .line 9
    iput-object p1, p0, Lcom/micloud/midrive/session/DownloadSession;->mProgressMap:Ljava/util/Map;
    ...
    .line 16
    iput-object p1, p0, Lcom/micloud/midrive/session/DownloadSession;->mFailTaskKeySet:Ljava/util/Set;
    ...
    .line 23
    iput-object p1, p0, Lcom/micloud/midrive/session/DownloadSession;->mSuccessTaskKeySet:Ljava/util/Set;

    .line 25
    new-instance p1, Lcom/micloud/midrive/session/DownloadSession$1;

    .line 27
    invoke-direct {p1, p0}, Lcom/micloud/midrive/session/DownloadSession$1;-><init>(Lcom/micloud/midrive/session/DownloadSession;)V

    .line 30
    iput-object p1, p0, Lcom/micloud/midrive/session/DownloadSession;->mNotificationRunnable:Ljava/lang/Runnable;

    .line 32
    return-void
.end method

.method public static synthetic access$000(Lcom/micloud/midrive/session/DownloadSession;)Z
    .registers 1

    .line 1
    invoke-direct {p0}, Lcom/micloud/midrive/session/DownloadSession;->doUpdateRunningNotificationH()Z
...
.method public static synthetic access$102(Lcom/micloud/midrive/session/DownloadSession;J)J
    .registers 3

    .line 1
    iput-wide p1, p0, Lcom/micloud/midrive/session/DownloadSession;->mProgressLastUpdateTime:J
...
.method private calculatedSpeedH()V
    ...
    .line 5
    iget-object v2, p0, Lcom/micloud/midrive/session/DownloadSession;->mTrafficSpeedInfo:Lcom/micloud/midrive/infos/TrafficSpeedInfo;
    ...
    .line 19
    iget-object v4, p0, Lcom/micloud/midrive/session/DownloadSession;->mTrafficSpeedInfo:Lcom/micloud/midrive/infos/TrafficSpeedInfo;
    ...
    .line 53
    iget-object v3, p0, Lcom/micloud/midrive/session/DownloadSession;->mTrafficSpeedInfo:Lcom/micloud/midrive/infos/TrafficSpeedInfo;
...
.method private doUpdateRunningNotificationH()Z
    ...
    .line 1
    iget v0, p0, Lcom/micloud/midrive/session/DownloadSession;->mOnGoingCount:I

    .line 3
    iget-object v1, p0, Lcom/micloud/midrive/session/DownloadSession;->mSuccessTaskKeySet:Ljava/util/Set;
    ...
    .line 9
    iget-object v2, p0, Lcom/micloud/midrive/session/DownloadSession;->mFailTaskKeySet:Ljava/util/Set;
    ...
    .line 49
    iget-boolean v7, p0, Lcom/micloud/midrive/session/DownloadSession;->mWaitNetwork:Z
    ...
    .line 81
    iget-boolean v8, p0, Lcom/micloud/midrive/session/DownloadSession;->mWaitNetwork:Z
...
.method private getCacheFileInfoH(Lcom/micloud/midrive/infos/TransferFileBaseInfo;)Lcom/micloud/midrive/infos/CachedFileInfo;
    ...
    .line 1
    invoke-direct {p0}, Lcom/micloud/midrive/session/DownloadSession;->getTransferTypeInnerH()Lcom/micloud/midrive/ui/bean/TransferTaskItem$TransferType;
...
.method private initTrafficSpeedInfoH()V
    ...
    .line 17
    iput-object v0, p0, Lcom/micloud/midrive/session/DownloadSession;->mTrafficSpeedInfo:Lcom/micloud/midrive/infos/TrafficSpeedInfo;
    ...
    .line 25
    iget-object v0, p0, Lcom/micloud/midrive/session/DownloadSession;->mTrafficSpeedInfo:Lcom/micloud/midrive/infos/TrafficSpeedInfo;
...
.method private recordSessionFinishH()V
    ...
    .line 1
    iget-object v0, p0, Lcom/micloud/midrive/session/DownloadSession;->mSessionResultStat:Lcom/micloud/midrive/stat/TransferSessionResultStat;
...
.method private saveProgressToSessionJobH()V
    ...
    .line 5
    iget-wide v2, p0, Lcom/micloud/midrive/session/DownloadSession;->mSaveProgressLastTime:J
    ...
    .line 20
    iget-object v3, p0, Lcom/micloud/midrive/session/DownloadSession;->mProgressMap:Ljava/util/Map;
    ...
    .line 66
    :cond_41
    iget-object v3, p0, Lcom/micloud/midrive/session/DownloadSession;->mSessionJobManager:Lcom/micloud/midrive/cache/manager/ISessionJobManager;

    .line 68
    invoke-interface {v3, v2}, Lcom/micloud/midrive/cache/manager/ISessionJobManager;->updateJobProgress(Ljava/util/Map;)V

    .line 71
    iput-wide v0, p0, Lcom/micloud/midrive/session/DownloadSession;->mSaveProgressLastTime:J
...
.method private updateProgressSnapshotH(Ljava/util/Collection;)V
    ...
    .line 56
    :cond_37
    iput-object v0, p0, Lcom/micloud/midrive/session/DownloadSession;->mProgressMap:Ljava/util/Map;
...
.method private updateRunningNotificationH()V
    ...
    .line 5
    iget-object v1, p0, Lcom/micloud/midrive/session/DownloadSession;->mNotificationRunnable:Ljava/lang/Runnable;

    .line 7
    invoke-virtual {v0, v1}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    .line 10
    iget-object v0, p0, Lcom/micloud/midrive/session/DownloadSession;->mNotificationRunnable:Ljava/lang/Runnable;
...
.method public getProgressInfo(Ljava/lang/String;)Lcom/micloud/midrive/infos/TaskProgressInfo;
    ...
    .line 1
    iget-object v0, p0, Lcom/micloud/midrive/session/DownloadSession;->mProgressMap:Ljava/util/Map;
...
.method public onCreateTransferTaskH(Lcom/micloud/midrive/task/RunOnNetworkTask$NetworkTaskContext;Lcom/micloud/midrive/infos/TransferFileBaseInfo;J)Lcom/micloud/midrive/task/TransferBaseTask;
    ...
    .line 1
    new-instance v0, Lcom/micloud/midrive/task/DownloadTask;

    .line 3
    check-cast p2, Lcom/micloud/midrive/infos/FileDownloadInfo;

    .line 5
    invoke-direct {v0, p1, p2, p3, p4}, Lcom/micloud/midrive/task/DownloadTask;-><init>(Lcom/micloud/midrive/task/RunOnNetworkTask$NetworkTaskContext;Lcom/micloud/midrive/infos/FileDownloadInfo;J)V
...
.method public onJobStatusChangedH()V
    ...
    .line 1
    iget-object v0, p0, Lcom/micloud/midrive/session/DownloadSession;->mSessionJobManager:Lcom/micloud/midrive/cache/manager/ISessionJobManager;
    ...
    .line 9
    iput v0, p0, Lcom/micloud/midrive/session/DownloadSession;->mOnGoingCount:I

    .line 11
    invoke-direct {p0}, Lcom/micloud/midrive/session/DownloadSession;->updateRunningNotificationH()V
...
.method public onSessionToExecuteH()V
    ...
    .line 8
    iput-object v0, p0, Lcom/micloud/midrive/session/DownloadSession;->mSessionResultStat:Lcom/micloud/midrive/stat/TransferSessionResultStat;
    ...
    .line 21
    iput-object v0, p0, Lcom/micloud/midrive/session/DownloadSession;->mSessionJobManager:Lcom/micloud/midrive/cache/manager/ISessionJobManager;

    .line 23
    invoke-direct {p0}, Lcom/micloud/midrive/session/DownloadSession;->initTrafficSpeedInfoH()V
...
.method public onSessionToFinishH()V
    ...
    .line 28
    iget-object v4, p0, Lcom/micloud/midrive/session/DownloadSession;->mSuccessTaskKeySet:Ljava/util/Set;
    ...
    .line 34
    iget-object v5, p0, Lcom/micloud/midrive/session/DownloadSession;->mFailTaskKeySet:Ljava/util/Set;
    ...
    .line 47
    invoke-direct {p0}, Lcom/micloud/midrive/session/DownloadSession;->recordSessionFinishH()V
...
.method public onTaskDoneH(Lcom/micloud/midrive/task/TransferBaseTask;)V
    ...
    .line 15
    iget-object v0, p0, Lcom/micloud/midrive/session/DownloadSession;->mFailTaskKeySet:Ljava/util/Set;

    .line 17
    invoke-interface {v0, v1}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    .line 20
    iget-object v0, p0, Lcom/micloud/midrive/session/DownloadSession;->mSuccessTaskKeySet:Ljava/util/Set;
    ...
    .line 41
    iget-object p1, p0, Lcom/micloud/midrive/session/DownloadSession;->mFailTaskKeySet:Ljava/util/Set;

    .line 43
    invoke-interface {p1, v1}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    .line 46
    iget-object p1, p0, Lcom/micloud/midrive/session/DownloadSession;->mSessionResultStat:Lcom/micloud/midrive/stat/TransferSessionResultStat;
    ...
    :cond_34
    :goto_34
    iget-object p1, p0, Lcom/micloud/midrive/session/DownloadSession;->mSessionJobManager:Lcom/micloud/midrive/cache/manager/ISessionJobManager;
    ...
    .line 61
    iput p1, p0, Lcom/micloud/midrive/session/DownloadSession;->mOnGoingCount:I

    .line 63
    invoke-direct {p0}, Lcom/micloud/midrive/session/DownloadSession;->calculatedSpeedH()V
...
.method public onTaskProgressChangedH(Ljava/util/Collection;)V
    ...
    .line 1
    invoke-direct {p0, p1}, Lcom/micloud/midrive/session/DownloadSession;->updateProgressSnapshotH(Ljava/util/Collection;)V

    .line 4
    invoke-direct {p0}, Lcom/micloud/midrive/session/DownloadSession;->saveProgressToSessionJobH()V
...
.method public onWaitNetworkChangedH(Z)V
    ...
    .line 6
    iput-boolean p1, p0, Lcom/micloud/midrive/session/DownloadSession;->mWaitNetwork:Z
