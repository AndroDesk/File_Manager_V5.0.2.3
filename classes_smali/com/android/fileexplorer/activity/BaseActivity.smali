.class public abstract Lcom/android/fileexplorer/activity/BaseActivity;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/android/fileexplorer/activity/BaseActivity;->SPEED_INTERVAL:I
...
.method public addDisposable(Lk2/b;)V
    ...
    iget-object v0, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mCompositeDisposable:Lk2/a;
    ...
    iput-object v0, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mCompositeDisposable:Lk2/a;
...
.method public cancelProcessDialog()V
    ...
    iget-object v0, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mProgressDialog:Lcom/android/fileexplorer/view/CancelableProgressDialog;
...
.method public dismissProgress()V
    ...
    invoke-virtual {p0}, Lcom/android/fileexplorer/activity/BaseActivity;->stopSpeedTimer()V

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mTotalSize:J

    sput-wide v0, Lcom/android/fileexplorer/activity/BaseActivity;->mPreUpdataUiTime:J

    iput-wide v0, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mAllSize:J
    ...
    iget-object v1, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mProgressDialog:Lcom/android/fileexplorer/view/CancelableProgressDialog;
    ...
    iput-object v0, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mProgressDialog:Lcom/android/fileexplorer/view/CancelableProgressDialog;
...
.method public getOverWriteDialog()Lmiuix/appcompat/app/AlertDialog;
    ...
    iget-object v0, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mAlertDialog:Lmiuix/appcompat/app/AlertDialog;
...
.method public getRequestDocumentPermissionDialog()Lmiuix/appcompat/app/AlertDialog;
    ...
    iget-object v0, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mRequestDocumentPermissionDialog:Lmiuix/appcompat/app/AlertDialog;
...
.method public declared-synchronized increaseProgressBy(J)V
    ...
    sget-wide v0, Lcom/android/fileexplorer/activity/BaseActivity;->mPreUpdataUiTime:J
    ...
    iget-wide v7, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mAllSize:J
    :try_end_1e
    ...
    :cond_25
    :try_start_25
    sput-wide p1, Lcom/android/fileexplorer/activity/BaseActivity;->mPreUpdataUiTime:J

    iget-object p1, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mProgressDialog:Lcom/android/fileexplorer/view/CancelableProgressDialog;

    if-eqz p1, :cond_3f

    iget-wide v0, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mDivider:D
    ...
    iget-wide v4, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mTotalSize:J
...
.method public isResume()Z
    ...
    iget-boolean v0, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mResumed:Z
...
.method public isStop()Z
    ...
    iget-boolean v0, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mStop:Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    :cond_2c
    invoke-virtual {p0}, Lcom/android/fileexplorer/activity/BaseActivity;->handleGesturePromptLineIfNeed()V
...
.method public onDestroy()V
    ...
    invoke-virtual {p0}, Lcom/android/fileexplorer/activity/BaseActivity;->dismissProgress()V

    invoke-virtual {p0}, Lcom/android/fileexplorer/activity/BaseActivity;->unDisposable()V
    ...
    iput-object v0, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mRequestDocumentPermissionDialog:Lmiuix/appcompat/app/AlertDialog;

    :cond_1b
    iget-object v0, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mContentObserver:Landroid/database/ContentObserver;
    ...
    iget-object v1, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mContentObserver:Landroid/database/ContentObserver;
...
.method public onPause()V
    ...
    iput-boolean v0, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mResumed:Z
...
.method public onResume()V
    ...
    iput-boolean v0, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mStop:Z
...
.method public resetProgress()V
    ...
    invoke-virtual {p0}, Lcom/android/fileexplorer/activity/BaseActivity;->startSpeedTimer()V
...
.method public setOverWriteDialog(Lmiuix/appcompat/app/AlertDialog;)V
    ...
    iput-object p1, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mAlertDialog:Lmiuix/appcompat/app/AlertDialog;
...
.method public setProgressMax(J)V
    ...
    iput-wide p1, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mAllSize:J

    invoke-virtual {p0, p1, p2}, Lcom/android/fileexplorer/activity/BaseActivity;->calculateProgressDivider(J)D

    move-result-wide v0

    iput-wide v0, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mDivider:D
    ...
    iput-wide v2, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mDivider:D
    ...
    iget-wide v3, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mDivider:D
...
.method public setRequestDocumentPermissionDialog(Lmiuix/appcompat/app/AlertDialog;)V
    ...
    iput-object p1, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mRequestDocumentPermissionDialog:Lmiuix/appcompat/app/AlertDialog;
...
.method public setSingleSizeDone(J)V
    ...
    iget-wide v2, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mDivider:D
...
.method public showLoadingDialog(I)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/fileexplorer/activity/BaseActivity;->showLoadingDialog(IZ)V
...
.method public showProgressDialog(I)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/fileexplorer/activity/BaseActivity;->showProgressDialog(IZ)V
...
.method public showProgressDialog(II)V
    ...
    invoke-virtual {p0, p1, p2, v0, v1}, Lcom/android/fileexplorer/activity/BaseActivity;->showProgressDialog(IIZZ)V
...
.method public showProgressDialog(IIZZ)V
    ...
    iput-object p4, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mProgressDialog:Lcom/android/fileexplorer/view/CancelableProgressDialog;
    ...
    iput-wide p3, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mDivider:D
...
.method public showProgressDialog(IZ)V
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/android/fileexplorer/activity/BaseActivity;->showProgressDialog(IZZ)V
...
.method public showProgressDialog(IZZ)V
    ...
    invoke-virtual {p0, p1, v0, p2, p3}, Lcom/android/fileexplorer/activity/BaseActivity;->showProgressDialog(IIZZ)V
...
.method public startSpeedTimer()V
    ...
    iput-object v1, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mSpeedUpdateTimer:Ljava/util/Timer;
...
.method public stopSpeedTimer()V
    ...
    iget-object v0, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mSpeedUpdateTimer:Ljava/util/Timer;
    ...
    iput-object v0, p0, Lcom/android/fileexplorer/activity/BaseActivity;->mSpeedUpdateTimer:Ljava/util/Timer;
